...
<div id="fullpage">
                ...
                <div class="top">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="#" onclick="Intercom('show');">Kontakta oss</a></li>
                        </ul>
    ...
    <footer class="section fp-auto-height" id="section-footer">
...
<p class="small">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <h3>SIDKARTA</h3>
                                ...
                                <p><a href="#" onclick="Intercom('show');">Kontakta oss</a></p>
                    </div>
...
<script>(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',intercomSettings);}else{var d=document;var i=function(){i.c(arguments)};i.q=[];i.c=function(args){i.q.push(args)};w.Intercom=i;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/tzqxa7nv';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})()</script>
</body>
</html>
